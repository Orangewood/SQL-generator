...
export default function BorderRow(props: BorderRowProps) {
  ...
  return (<>
    <div className="row-container">
      <Dropdown selectOptions={predicateDropdown} onSelect={(value: DropdownOperator) => setRowType(value.type)} />
    </div>

    <div><Dropdown selectOptions={rowType === 'number' ? numberDropdown : stringDropdown} onSelect={(value: DropdownOperator) => setRowData(value.value)} /></div>
